...
public class FakePlayerUtil extends AbstractClientPlayerEntity {
    ...
    private static final OtherClientPlayerEntity player = new OtherClientPlayerEntity(mc.world, new GameProfile(UUID.fromString("0155842b-0328-4e6a-94ee-4b3b9cd85c01"), "zyklon_gigachad"), mc.player.getPublicKey());
