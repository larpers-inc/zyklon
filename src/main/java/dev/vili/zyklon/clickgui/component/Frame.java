...
public class Frame {
	...
	public void renderFrame(MatrixStack matrixStack, TextRenderer textRenderer) {
		// Draw frame
		DrawableHelper.fill(matrixStack, this.x, this.y , this.x + this.width, this.y + this.barHeight, new Color(36, 36, 36, 191).getRGB());
		// Fill outline of frame with black
		DrawableHelper.fill(matrixStack, this.x, this.y + this.barHeight, this.x + this.width, this.y + this.barHeight + 1, new Color(0, 0, 0, 191).getRGB());
		DrawableHelper.fill(matrixStack, this.x, this.y, this.x + this.width, this.y + 1, new Color(0, 0, 0, 191).getRGB());
		DrawableHelper.fill(matrixStack, this.x, this.y, this.x + 1, this.y + this.barHeight, new Color(0, 0, 0, 191).getRGB());
		DrawableHelper.fill(matrixStack, this.x + this.width - 1, this.y, this.x + this.width, this.y + this.barHeight, new Color(0, 0, 0, 191).getRGB());
