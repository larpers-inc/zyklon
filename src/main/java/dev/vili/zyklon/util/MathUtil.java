...
public class MathUtil {
    ...
    public static boolean isSame(BlockPos blockPos, BlockPos blockPos1) {
    ...
    public static float getDistance(Vec3d vec, Vec3d vec1) {
    ...
    public static float getDistance2D(Vec2f vec, Vec2f vec1) {
        double d0 = vec.x - vec1.x;
        double d1 = vec.y - vec1.y;
        return MathHelper.sqrt((float)(d0 * d0 + d1 * d1));
    }

    public static float getDistance2D(Vec3d vec, Vec3d vec1) {
        double d0 = vec.x - vec1.x;
    ...
    public static Vec3d getVec(BlockPos blockPos) {
